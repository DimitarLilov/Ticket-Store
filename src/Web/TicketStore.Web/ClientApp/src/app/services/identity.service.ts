...
export class IdentityService {
    ...
    private static readonly FIRST_NAME_KEY = 'IDENTITY_FIRST_NAME';
    ...
    public getFirstName(): string {
        if (!this.firstName) {
            this.firstName = this.storageService.getItem(IdentityService.FIRST_NAME_KEY);
        }
    ...
    public setFirstName(firstName: any): void {
        ...
        this.storageService.setItem(IdentityService.FIRST_NAME_KEY, firstName);
    }
    ...
    private removeFirstName(): void {
        this.firstName = null;
        this.storageService.removeItem(IdentityService.FIRST_NAME_KEY);
    }
}
